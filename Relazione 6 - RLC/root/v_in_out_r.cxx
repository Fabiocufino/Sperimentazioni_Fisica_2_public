...
void v_in_out_r()
{
    ...
    fit_results df_r;
    fit_on_json(fit_parab, 3, grafico_vin, df.freq, df.v_in, df_r, "../Fit_results", "fit_parabolico_v_in_R.json", 49.5, 53);
    ...
    grafico_vout->SetMarkerSize(0.8);
    ...
    fit_results df_r2;
    fit_on_json(fit_parab2, 3, grafico_vout, df.freq, df.v_out, df_r2, "../Fit_results", "fit_parabolico_v_out_R.json", 49.5, 53);
