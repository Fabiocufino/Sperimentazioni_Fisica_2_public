...
void fit_parabolico_c()
{
    ...
    grafico_trasf->SetTitle("Fit Parabolico su Trasferimento C");
    ...
    fit_results df_r;
    fit_on_json(fit_lin, 3, grafico_trasf, df.freq, trasferimento, df_r, "../Fit_results", "fit_parabolico_c.json", 50000, 52250);
