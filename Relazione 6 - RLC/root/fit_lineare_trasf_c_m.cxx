...
void fit_lineare_trasf_c_m()
{
    d_frequenza df;
    df.from_json("../Json", "fit_lineare_c_m.json");
    ...
    grafico_trasf->SetTitle("Fit Linere su Trasferimento C, frequenza taglio (-)");
    ...
    fit_results df_r;
    fit_on_json(fit_lin, 2, grafico_trasf, df.freq, trasferimento, df_r, "../Fit_results", "lin_c_m_trasferimento.json", 20e03, 100e03);
