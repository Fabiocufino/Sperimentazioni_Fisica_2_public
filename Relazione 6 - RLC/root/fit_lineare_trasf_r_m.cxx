...
void fit_lineare_trasf_r_m()
{
    d_frequenza df;
    df.from_json("../Json", "fit_lineare_r_m.json");
    ...
    fit_results df_r;
    fit_on_json(fit_lin, 2, grafico_trasf, df.freq, trasferimento, df_r, "../Fit_results", "lin_r_m_trasferimento.json", 20e03, 100e03);
