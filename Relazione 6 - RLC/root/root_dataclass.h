...
public:
    ...
    void root_to_json(string directory, string fname)
    {
        ...
        j = json{
            ...
            {"a-d covariance", covariance_matrix[0][3]},
            {"b-d covariance", covariance_matrix[1][3]},
            {"c-d covariance", covariance_matrix[2][3]},
    ...
    void root_from_json(string directory, string fname)
    {
        ...
        j.at("a-d covariance").get_to(covariance_matrix[0][3]);
        j.at("b-d covariance").get_to(covariance_matrix[1][3]);
        j.at("c-d covariance").get_to(covariance_matrix[2][3]);
