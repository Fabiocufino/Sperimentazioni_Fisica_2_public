...
void scarica_c_exp()
{
    ...
    TVectorD root_v_v0(scarica.v_v0.size(), scarica.v_v0.data());
    TVectorD root_err_tempo(scarica.err_t.size(), scarica.err_t.data());
    TVectorD root_err_v_v0(scarica.err_v_v0.size(), scarica.err_v_v0.data());
    ...
    fit_results scarica_results;
    fit_on_json(f1, 2, grafico, scarica.t, scarica.v_v0, scarica_results, "../Fit_results", "scarica_c_esponenziale.json");

    TPaveStats *ptstats;
    TText *ptstats_LaTex;
    fit_results fit_results;
    fit_results.root_from_json("../Fit_results", "scarica_c_esponenziale.json");
    ...
    vector<double> err_t(scarica.err_v_v0.size(), 0);
    TVectorD root_err_t(err_t.size(), err_t.data());

    vector<double> scarti;

    run_test_exp(scarti, scarica.t, scarica.v_v0, fit_results.a[0], fit_results.b[0]);
