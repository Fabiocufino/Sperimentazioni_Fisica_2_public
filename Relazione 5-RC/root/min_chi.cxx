...
void min_chi()
{
    ...
    compute_minimization_from_json("../Json/", "min_chi_passa_basso.json", freq_trasf, chi_trasf);
    compute_minimization_from_json("../Json/", "min_chi_passa_basso_sfasamento.json", freq_sfas, chi_sfas);
    ...
    fit_on_json(f1, 3, grafico, freq_trasf, chi_trasf, chi_results, "../Fit_results", "min_chi_passa_basso.json", 5.9, 6.05);
    ...
    latex.DrawLatex(6, 100, "#Delta#chi+1");
    latex.DrawLatex(6, 150, "f_{taglio} #approx 5.961");
    ...
    TF1 *f2 = new TF1("f2", func, 6.05, 6.13, 3);
    f2->SetLineColor(kRed);
    f2->SetLineStyle(2);
    f2->SetLineWidth(2);

    fit_results chi_results_sfas;
    fit_on_json(f2, 3, grafico1, freq_sfas, chi_sfas, chi_results_sfas, "../Fit_results", "min_chi_passa_basso_sfasamento.json", 6.05, 6.13);
    ...
    TLine *min = new TLine(6.08, chi_two, 6.11, chi_two);
    min->SetLineColor(kRed);
    min->Draw("same");

    TLine *mint1 = new TLine(x_min, 427, x_min, chi_two);
    ...
    latex1.DrawLatex(6, 400, "#Delta#chi+1");
    latex1.DrawLatex(6, 500, "f_{taglio} #approx 6.096");
